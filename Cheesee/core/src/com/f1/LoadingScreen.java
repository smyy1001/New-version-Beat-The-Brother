...
public class LoadingScreen extends BaseScreen{
    ...
    // constructor
    public LoadingScreen(CheeseGame g) {
        super(g);
        this.game = g;
    }
    ...
    public void create() {
        ...
        if(CheeseLevel.player1.getScore() == 0) {
            score1.setTexture(new Texture(Gdx.files.internal("assets/number0.png")));
        }
        else if(CheeseLevel.player1.getScore() == 1) {
        ...
        if(CheeseLevel.player2.getScore() == 0) {
            score2.setTexture(new Texture(Gdx.files.internal("assets/number0.png")));
        }
        else if(CheeseLevel.player2.getScore() == 1) {
    ...
    public void update(float dt) {
        ...
        if(Gdx.input.justTouched()){
            ...
            if(rect.contains(touchX,touchY)) {game.setScreen(new CheeseLevel(game));}
        }
